...
VCU vcu(&pedals, &inverter, &accumulator, &params, &kms_can, &acc_can, &inv_can,
        &daq_can, &wrapped_1s, &wrapped_10hz, &wrapped_10hz, &wrapped_200hz,
        &wrapped_10hz_2, &reset_wrapped_10hz_2);
