...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "Juse_Use_SdFat"
  WORKING_DIRECTORY "/home/klee/Github/VCU/build/_deps/sd-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "Juse_Use_SdFat")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("Juse_Use_SdFat" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: Juse_Use_SdFat")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/Juse_Use_SdFat")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"Juse_Use_SdFat\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/klee/Github/VCU/build/_deps/sd-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/klee/Github/VCU/build/_deps/sd-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
execute_process(
  COMMAND "/usr/bin/git" show-ref "Juse_Use_SdFat"
  WORKING_DIRECTORY "/home/klee/Github/VCU/build/_deps/sd-src"
  OUTPUT_VARIABLE show_ref_output
  )
...
if("${show_ref_output}" MATCHES "refs/remotes/Juse_Use_SdFat")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "Juse_Use_SdFat")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "Juse_Use_SdFat")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/PaulStoffregen/SD.git'")
  endif()
